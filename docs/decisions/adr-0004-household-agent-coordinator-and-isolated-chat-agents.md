...
supersede the earlier plain-child and custom-transport selections.

- Status: Accepted
- Date: 2026-08-25
- Related product decision: [PDR-0007](pdr-0007-household-agent-conversations-and-visibility.md)
...
[Work Item 03](../plans/private-discovery/03-adaptive-discovery-and-evaluation.md)
...
The [v25/policy-v6 contract](../reference/discovery-coverage.md)
