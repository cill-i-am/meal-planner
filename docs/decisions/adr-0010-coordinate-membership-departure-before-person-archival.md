...
- Related product decisions:
  [PDR-0001](pdr-0001-household-people-profiles-and-interviews.md)
  and
  [PDR-0016](pdr-0016-beta-support-incidents-and-operator-repair.md)
- Extends:
  [ADR-0001](adr-0001-separate-household-people-from-auth-members.md)
...
[household deletion lifecycle](../explanation/household-authority.md#future-household-deletion-requirement),
