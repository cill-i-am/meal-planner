...
results. The [work item](03-adaptive-discovery-and-evaluation.md#current-evaluation-status)
...
No import, accounting or planner implementation is changed by this documentation
cleanup.
