...
- Current contract: [Application-owned discovery coverage](03-deterministic-discovery-contract.md).
- Runtime decision: [ADR-0004](../../../architecture/decisions/0004-household-agent-coordinator-and-isolated-chat-agents.md#base-agent-and-tanstack-chat--accepted-2026-09-13).
