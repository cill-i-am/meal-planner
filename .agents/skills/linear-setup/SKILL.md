...
`execution-policy.md` is the canonical authority owner. Preserve its semantics when adapting role templates; do not add project-local plan approval, reviewer edit authority, routine pre-edit review, or duplicate watcher requirements.
