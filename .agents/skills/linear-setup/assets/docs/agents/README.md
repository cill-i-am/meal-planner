...
- `execution-policy.md`: canonical Dispatch, Build, Verify, Decide phases; role authority; risk tiers; finding disposition; physical proof; and watcher ownership.
...
Role skills and these templates consume `execution-policy.md`; capability skills provide techniques inside a phase and must not invent authority transitions.
