...
- **Blocked:** missing credentials, provider state, failing baseline, out-of-scope reviewer feedback, unresolved HITL, or external CI/provider failure prevents completion.
